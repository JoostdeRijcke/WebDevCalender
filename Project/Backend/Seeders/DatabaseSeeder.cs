        ...
        public static void Seed(MyContext context)
        {
            ...
            if (!context.Events.Any())
            {
                context.Events.AddRange(
                    ...
                    new Event { Title = "Holiday Party", Description = "End of year celebration", Date = new DateTime(2025, 12, 2), StartTime = TimeSpan.FromHours(18), EndTime = TimeSpan.FromHours(22), Location = "Banquet Hall", AdminApproval = true },
                    new Event { Title = "Winter Workshop", Description = "Planning for next quarter", Date = new DateTime(2025, 12, 5), StartTime = TimeSpan.FromHours(10), EndTime = TimeSpan.FromHours(12), Location = "Conference Room B", AdminApproval = true },
                    new Event { Title = "Standup Meeting", Description = "Weekly team sync", Date = new DateTime(2025, 12, 9), StartTime = TimeSpan.FromHours(9), EndTime = TimeSpan.FromHours(10), Location = "Room 101", AdminApproval = true },
                    new Event { Title = "Fitness Challenge", Description = "Team health competition", Date = new DateTime(2025, 12, 11), StartTime = TimeSpan.FromHours(17), EndTime = TimeSpan.FromHours(18), Location = "Fitness Center", AdminApproval = true },
                    new Event { Title = "Demo Day", Description = "Showcase completed projects", Date = new DateTime(2025, 12, 13), StartTime = TimeSpan.FromHours(14), EndTime = TimeSpan.FromHours(16), Location = "Innovation Lab", AdminApproval = true },
                    new Event { Title = "Social Lunch", Description = "Team bonding activity", Date = new DateTime(2025, 12, 16), StartTime = TimeSpan.FromHours(12), EndTime = TimeSpan.FromHours(13), Location = "Restaurant", AdminApproval = true },
                    new Event { Title = "Training Session", Description = "New tools orientation", Date = new DateTime(2025, 12, 18), StartTime = TimeSpan.FromHours(15), EndTime = TimeSpan.FromHours(17), Location = "Training Room", AdminApproval = true },
                    new Event { Title = "Year-End Meeting", Description = "Closing the year", Date = new DateTime(2025, 12, 20), StartTime = TimeSpan.FromHours(11), EndTime = TimeSpan.FromHours(12), Location = "Auditorium", AdminApproval = true },
                    new Event { Title = "Holiday Yoga", Description = "Relaxation session", Date = new DateTime(2025, 12, 23), StartTime = TimeSpan.FromHours(8), EndTime = TimeSpan.FromHours(9), Location = "Fitness Studio", AdminApproval = true },
                    new Event { Title = "Competition Finals", Description = "Hackathon winners announced", Date = new DateTime(2025, 12, 27), StartTime = TimeSpan.FromHours(14), EndTime = TimeSpan.FromHours(16), Location = "Conference Room A", AdminApproval = true },
                    new Event { Title = "Winter Presentation", Description = "Q4 results", Date = new DateTime(2025, 12, 29), StartTime = TimeSpan.FromHours(10), EndTime = TimeSpan.FromHours(11), Location = "Boardroom", AdminApproval = true },
                    new Event { Title = "New Year's Party", Description = "Celebration event", Date = new DateTime(2025, 12, 31), StartTime = TimeSpan.FromHours(20), EndTime = TimeSpan.FromHours(23), Location = "Event Hall", AdminApproval = true },

                    // February 2026 Events
                    new Event { Title = "Valentine's Social", Description = "Team social event", Date = new DateTime(2026, 2, 3), StartTime = TimeSpan.FromHours(18), EndTime = TimeSpan.FromHours(20), Location = "Lounge", AdminApproval = true },
                    new Event { Title = "Workshop Training", Description = "Advanced skills development", Date = new DateTime(2026, 2, 6), StartTime = TimeSpan.FromHours(10), EndTime = TimeSpan.FromHours(12), Location = "Training Hall", AdminApproval = true },
                    new Event { Title = "Monthly Standup", Description = "February team sync", Date = new DateTime(2026, 2, 10), StartTime = TimeSpan.FromHours(9), EndTime = TimeSpan.FromHours(10), Location = "Conference Room B", AdminApproval = true },
                    new Event { Title = "Love Run", Description = "Valentine's themed 5K", Date = new DateTime(2026, 2, 14), StartTime = TimeSpan.FromHours(7), EndTime = TimeSpan.FromHours(9), Location = "City Park", AdminApproval = true },
                    new Event { Title = "Product Demo", Description = "February feature showcase", Date = new DateTime(2026, 2, 17), StartTime = TimeSpan.FromHours(14), EndTime = TimeSpan.FromHours(15), Location = "Auditorium", AdminApproval = true },
                    new Event { Title = "Team Lunch", Description = "Mid-month gathering", Date = new DateTime(2026, 2, 19), StartTime = TimeSpan.FromHours(12), EndTime = TimeSpan.FromHours(13), Location = "Cafeteria", AdminApproval = true },
                    new Event { Title = "Spring Planning", Description = "Q2 strategy session", Date = new DateTime(2026, 2, 21), StartTime = TimeSpan.FromHours(10), EndTime = TimeSpan.FromHours(12), Location = "Boardroom", AdminApproval = true },
                    new Event { Title = "Tech Presentation", Description = "New technologies review", Date = new DateTime(2026, 2, 24), StartTime = TimeSpan.FromHours(15), EndTime = TimeSpan.FromHours(16), Location = "Tech Hub", AdminApproval = true },
                    new Event { Title = "Fitness Friday", Description = "Weekly health session", Date = new DateTime(2026, 2, 7), StartTime = TimeSpan.FromHours(17), EndTime = TimeSpan.FromHours(18), Location = "Gym", AdminApproval = true },
                    new Event { Title = "Hackathon Prep", Description = "Getting ready for March competition", Date = new DateTime(2026, 2, 12), StartTime = TimeSpan.FromHours(13), EndTime = TimeSpan.FromHours(15), Location = "Innovation Lab", AdminApproval = true },
                    new Event { Title = "Monthly Meeting", Description = "February business review", Date = new DateTime(2026, 2, 26), StartTime = TimeSpan.FromHours(11), EndTime = TimeSpan.FromHours(12), Location = "Conference Room A", AdminApproval = true },
                    new Event { Title = "Party Night", Description = "End of month celebration", Date = new DateTime(2026, 2, 28), StartTime = TimeSpan.FromHours(19), EndTime = TimeSpan.FromHours(22), Location = "Recreation Hall", AdminApproval = true }
